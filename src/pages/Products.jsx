    ...
    <div className="bg-white text-[#0c0c0d]">
      ...
      <section className="w-full bg-white my-[24px] md:my-[50px]">
        <div className="max-w-[1440px] w-full mx-auto py-[24px] md:py-[50px] px-5 md:px-8 lg:px-12 xl:px-[94px] flex flex-col items-center gap-[24px] md:gap-[50px]">
          <AnimateOnScroll animation="fade-down" className="flex flex-col items-center gap-3 sm:gap-6">
            <span className="inline-flex items-center gap-2 rounded-[24px] border border-[#2a2a2a] bg-black px-[15px] py-[7px] text-xs sm:text-sm text-white font-medium">
      ...
      <section className="w-full bg-black">
        <AnimateOnScroll animation="fade-up" className="max-w-[1440px] mx-auto py-[24px] md:py-[50px] px-5 md:px-8 lg:px-12 xl:px-[94px] flex justify-center">
          <div
            className="flex w-full max-w-[1252px] flex-col md:flex-row items-start gap-4 sm:gap-6 rounded-[16px] sm:rounded-[24px] border border-[#ffb200]/10 p-4 sm:p-6 md:pt-[40px] md:pr-8 lg:md:pr-[96px] md:pb-[40px] md:pl-[39px] bg-gradient-to-br from-[#111111]/85 to-[#0b0b0f]/85"
            style={{
              backgroundImage:
                "linear-gradient(168deg, rgba(17,17,17,0.8) 0%, rgba(11,11,15,0.8) 100%)",
            }}
          >
            <div className="flex w-9 h-9 sm:w-12 sm:h-12 shrink-0 items-center justify-center rounded-xl sm:rounded-2xl border border-[#ffb200]/20 bg-gradient-to-br from-[#ff6a00]/20 to-[#ffb200]/10">
              <img
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                <h2
                  className="text-base sm:text-[20px] font-bold text-white leading-snug sm:leading-[28px]"
      ...
      >
        ...
        <div className="relative flex w-full lg:w-[487px] flex-col items-start gap-4 sm:gap-6 z-10">
          ...
          <ul
            className="flex flex-col gap-2 sm:gap-3 text-xs sm:text-sm text-[#B3B3B3] font-normal"
            style={{ fontFamily: "Inter", color: "#B3B3B3" }}
          >
        ...
        <div
          className="relative w-full lg:w-[480px] rounded-[16px] sm:rounded-[24px] border border-gray-200 bg-white p-4 sm:p-8 md:p-10 z-10"
          style={{ boxShadow: "0 0 10px rgba(0,0,0,0.05)" }}
        >
          <span
            className="absolute inline-flex rotate-3 items-center rounded-full text-[10px] sm:text-sm font-bold text-white shadow-lg"
            style={{
              top: "16px",
              right: "12px",
              paddingTop: "4px",
          ...
          <h3
            className="text-xl sm:text-3xl font-bold text-[#0c0c0d]"
            style={{ fontFamily: "Inter" }}
          >
            Send an Inquiry
          </h3>
          <p
            className="mt-1 sm:mt-2 text-xs sm:text-sm text-[#989898] font-normal"
          ...
          <a
            ...
            className="mt-4 sm:mt-6 flex w-full items-center justify-center gap-2 sm:gap-3 rounded-xl sm:rounded-2xl py-3 sm:py-5 text-white btn-gradient-primary"
          >
            <svg
              width="16"
              height="16"
            ...
            <span className="text-sm sm:text-lg font-bold" style={{ fontFamily: "Inter" }}>
              Contact Us Now
            </span>
          ...
          <div
            className="mt-4 sm:mt-6 flex flex-col gap-2 sm:gap-3 border-t border-gray-200 pt-3 sm:pt-4 text-xs sm:text-sm"
            style={{ fontFamily: "Inter" }}
          >
