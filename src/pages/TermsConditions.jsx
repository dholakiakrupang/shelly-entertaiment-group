    ...
    <div className="bg-black">
      ...
      <section className="bg-white w-full py-[50px] md:py-[77px] px-5 md:px-8 lg:px-12 xl:px-[94px]">
        <div className="max-w-[1440px] mx-auto w-full flex flex-col gap-[50px] items-start">
          ...
          <div
            className="bg-white border border-[#e2e2e2] rounded-[20px] w-full flex items-start gap-3 px-6 py-6"
            style={{ boxShadow: "0 0 10px rgba(0,0,0,0.05)" }}
          >
            <WarningIcon />
            <p className="text-lg text-black leading-7" style={{ fontFamily: "Inter" }}>
          ...
          <div className="flex flex-col gap-3 items-start w-full">
            ...
            <div className="text-[#989898]">
              <p className="leading-7">The content provided on this website, including product descriptions, partner information, and compliance data, is for general informational and educational purposes.</p>
              <ul className="list-disc ml-[27px]">
                <li className="leading-7">We do not operate an online casino.</li>
                <li className="leading-7">We do not facilitate betting or wagering.</li>
                <li className="leading-7">We do not process financial transactions for gambling purposes.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 items-start w-full">
            ...
            <p className="text-[#989898] leading-7">Liberty Rewards showcases skill-based gaming systems and sweepstakes promotional engines. The legality of these products varies by jurisdiction.</p>
            <ul className="list-disc ml-[27px]">
              <li className="text-[#989898] leading-7">
