          ...
          >
            ...
            <div className="flex flex-col gap-3 items-start w-full">
              ...
              <div className="text-[#989898]">
                <p className="leading-6 md:leading-7">We may collect personal information that you voluntarily provide to us when you:</p>
                <ul className="list-disc ml-4 md:ml-[27px]">
                  <li className="leading-6 md:leading-7">Submit an inquiry via our contact forms.</li>
                  <li className="leading-6 md:leading-7">Request product specifications or partner information.</li>
                  <li className="leading-6 md:leading-7">Subscribe to our newsletters or updates.</li>
                </ul>
              </div>
            </div>
